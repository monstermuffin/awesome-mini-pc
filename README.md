...
[![Device Count](https://img.shields.io/endpoint?url=https://awesomeminipc.com/stats.json&query=$.deviceCount&label=devices&color=blue)](https://github.com/monstermuffin/awesome-mini-pcs/tree/main/data/devices)
