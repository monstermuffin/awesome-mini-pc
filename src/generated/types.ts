...
export const BRANDS = ["Acemagic","Beelink","Dell","GEEKOM","GMKTec","Intel","Lenovo","Minisforum","NVIDIA","NiPoGi","Radxa","Raspberry Pi Foundation"] as const;
...
export const STORAGE_INTERFACES = ["Embedded","PCIe 2.0","PCIe 2.0 x4","PCIe 3.0","PCIe 3.0 x2","PCIe 3.0 x4","PCIe 4.0","PCIe 4.0 x1","PCIe 4.0 x4","PCIe NVMe","SATA","SATA 6.0","SATA3","SD","eMMC"] as const;
