...
export const BRANDS = ["AOOSTAR","ASRock","ASUS","Acemagic","Beelink","Dell","FriendlyElec","GEEKOM","GMKTec","HP","Intel","Lenovo","MINISFORUM","Minisforum","NVIDIA","NiPoGi","Protectli","Radxa","Raspberry Pi Foundation","Topton","UGREEN"] as const;
...
export const STORAGE_INTERFACES = ["Embedded","PCIe 2.0","PCIe 2.0 x4","PCIe 2.1","PCIe 3.0","PCIe 3.0 x1","PCIe 3.0 x2","PCIe 3.0 x4","PCIe 4.0","PCIe 4.0 x1","PCIe 4.0 x4","PCIe 5.0 x4","PCIe NVMe","SATA","SATA 6.0","SATA3","SD","eMMC"] as const;
