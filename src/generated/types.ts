...
export const BRANDS = ["Acemagic","Beelink","GEEKOM","GMKTec","Intel","Minisforum","NiPoGi"] as const;
...
export const WIFI_STANDARDS = ["None","WiFi 5","WiFi 6","WiFi 6E","WiFi 7"] as const;
