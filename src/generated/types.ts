...
export const BRANDS = ["ASRock","ASUS","Acemagic","Beelink","Dell","FriendlyElec","GEEKOM","GMKTec","HP","Intel","Lenovo","MINISFORUM","Minisforum","NVIDIA","NiPoGi","Protectli","Radxa","Raspberry Pi Foundation","Topton","UGREEN"] as const;
